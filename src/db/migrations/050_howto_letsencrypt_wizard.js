...
// One bilingual How-To guide for the v6.5 Let's Encrypt Wizard.
...
exports.up = function (db) {
  const guide = {
    ...
    title_ro: 'Cere un certificat Let\'s Encrypt via DNS challenge',
    category: 'security',
    ...
    summary_ro: 'Emite certificate Let\'s Encrypt gratuite din Docker Dash via DNS-01 challenge — funcționează pe rețele interne, suportă wildcards, cu 5 provideri DNS (Cloudflare, Route53, DigitalOcean, Hetzner, Linode).',
    content: `<h2>What this wizard does</h2>
...
exports.down = function (db) {
  db.prepare(`DELETE FROM howto_guides WHERE slug = 'letsencrypt-dns-wizard' AND is_builtin = 1`).run();
};
