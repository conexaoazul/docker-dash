...
// Bilingual How-To guide for v6.6.2 Egress Audit (System → Egress tab).

exports.up = function (db) {
  const guide = {
    slug: 'egress-audit',
    title: 'Audit Container Outbound Network Posture',
    title_ro: 'Auditează postura de rețea outbound a containerelor',
    category: 'security',
    difficulty: 'beginner',
    ...
    summary_ro: 'Vezi ce containere pot ajunge la internetul public și la endpoint-urile cloud-metadata (IMDS). Identifică riscurile de furt de credențiale dintr-un container compromis. Read-only — enforcement-ul vine în v6.7.',
    content: `<h2>What the audit shows</h2>
...
`,
    content_ro: `<h2>Ce arată auditul</h2>
...
exports.down = function (db) {
  db.prepare(`DELETE FROM howto_guides WHERE slug = 'egress-audit' AND is_builtin = 1`).run();
};
